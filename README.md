...
- **API (Postman/Newman)** — `postman/swipre-usuarios.postman_collection.json` trae 12 peticiones HTTP directas contra `server.js` (CP-02-01, CP-02-02, CP-02-03), ejecutadas con **Newman** (el CLI de Postman).
...
node server.js &         # levanta el servidor en http://localhost:3010
